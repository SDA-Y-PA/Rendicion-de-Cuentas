...
map.getView().fit([-8602719.910585, 308056.176075, -8095640.855386, 632034.445703], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Rendición de Cuentas SDA & PA</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (70 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Inversión Total: $16.412.073.039,07<br />Benefeciarios Total:<br />Proyectos: 17';
            }
